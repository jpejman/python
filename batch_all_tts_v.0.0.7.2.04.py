...
# Updated: 2025-05-25 22:08 EDT for v.0.0.7.2.03
# Updated: 2025-05-25 22:31 EDT for v.0.0.7.2.04
...
# Changelog v.0.0.7.2.03:
# - No core logic changes; version increment for continuity and checkpoints
# Changelog v.0.0.7.2.04:
# - Preparing for Tortoise integration — placeholder support to follow
# - Confirmed speaker "p238" as the default Coqui benchmark
# - Added comment hooks for future model-specific voice IDs (e.g., for Tortoise)
...
SCRIPT_VERSION = "batch_all_tts_v.0.0.7.2.04.py"
CREATED_TIMESTAMP = "2025-05-25 22:31 EDT"
...
print(f"☺️ Detected GPUs: {len(GPUS)}")
